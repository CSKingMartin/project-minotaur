...
const renderHtmlCode = (component) => Dom.renderToStaticMarkup(component);

/* eslint-disable */
const getChildren = (children, context) => typeof children === 'function' ? children(context) : children;
/* eslint-enable */
